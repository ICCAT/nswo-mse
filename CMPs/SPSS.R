...
# unconstrained
SPSSFox3 <- function(x, Data, Data_Lag=2, Interval=3, tunepar=1, mc=0.8, ...) {
...
#' @export
SPSSFox_c <- SPSSFox
formals(SPSSFox_c)$tunepar <- 0.552091716715639
class(SPSSFox_c) <- "MP"
...
#' @export
SPSSFox_d <- SPSSFox
formals(SPSSFox_d)$tunepar <- 0.58657150368945
class(SPSSFox_d) <- "MP"
...
#' @export
SPSSFox_e <- SPSSFox
formals(SPSSFox_e)$tunepar <- 0.61109469508279
class(SPSSFox_e) <- "MP"
...
#' @export
SPSSFox2_c <- SPSSFox2
formals(SPSSFox2_c)$tunepar <- 0.552091716715639
class(SPSSFox2_c) <- "MP"
...
#' @export
SPSSFox2_d <- SPSSFox2
formals(SPSSFox2_d)$tunepar <- 0.586729469688956
class(SPSSFox2_d) <- "MP"
...
#' @export
SPSSFox2_e <- SPSSFox2
formals(SPSSFox2_e)$tunepar <- 0.616778541156651
class(SPSSFox2_e) <- "MP"
...
#' @export
SPSSFox3_b <- SPSSFox3
formals(SPSSFox3_b)$tunepar <- 0.541284860998125
class(SPSSFox3_b) <- "MP"
...
#' @export
SPSSFox3_c <- SPSSFox3
formals(SPSSFox3_c)$tunepar <- 0.515035297484507
class(SPSSFox3_c) <- "MP"
...
#' @export
SPSSFox3_d <- SPSSFox3
formals(SPSSFox3_d)$tunepar <- 0.578725694232317
class(SPSSFox3_d) <- "MP"
...
#' @export
SPSSFox3_e <- SPSSFox3
formals(SPSSFox3_e)$tunepar <- 0.632372484473566
class(SPSSFox3_e) <- "MP"
