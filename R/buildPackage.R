...
# BuildData(redoOM=FALSE, redoMSE=TRUE) # add Data file to data directory
...
#'
#' @param redom Logical. Re-build `plot(SWOM)`?
...
BuildData <- function(redoOM=FALSE, redoMSE=FALSE) {
