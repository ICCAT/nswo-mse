...
#'
#' A modified version of `MSEtool::SS2OM` for importing Swordfish SS OMs.
#'
...
#' @param AgeRec Numeric. Age of recruitment. Default is 1 to match MSEtool/DLMtool Operating Model.
...
#' @export
#' @importFrom graphics abline hist legend lines par plot points matplot text segments
#' @importFrom grDevices dev.off gray png
#' @importFrom methods new slot
#' @importFrom utils packageVersion
#' @importFrom stats acf aggregate dnorm optim qlnorm qnorm quantile rnorm sd
#' @importFrom DLMtool runMSE
#' @importFrom MSEtool Assessment
SWO_SS2OM <- function(SSdir, nsim = 48, proyears = 50, reps = 1, maxF = 3,
                      seed = 1, interval=1, Obs = DLMtool::Generic_Obs,
  ...
  Perr_hist <- matrix(rep(recs, each = nsim), nrow = nsim, ncol=maxage+nyears-1) # Historical recruitment is deterministic
