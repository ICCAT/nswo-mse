...
#' @export
SP1_a <- SP1
formals(SP1_a)$tunepar <- 1.00732609275053
class(SP1_a) <- "MP"
...
#' @export
SP1_b <- SP1
formals(SP1_b)$tunepar <- 1.07142857142857
class(SP1_b) <- "MP"
...
#' @export
SP1_e <- SP1
formals(SP1_e)$tunepar <- 1.05251409774436
class(SP1_e) <- "MP"
...
#' @export
SP1_h <- SP1
formals(SP1_h)$tunepar <- 1.05535714285714
class(SP1_h) <- "MP"
