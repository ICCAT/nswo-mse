...
```{r data-fig, fig.cap='Summary of the data used in the 2022 stock assessment.', out.width = "400px"}
...
```{r r1-compare, fig.cap='The fishing mortality and spawning biomass relative to MSY reference points for R0 (reference OM) and R1, the robustness test that assumed the indices were corrected for an assumed 1 percent annual increase in catchability.', out.width = "400px"}
...
## R3a and R3b. Effect of Climate Change on Recruitment Deviations in Projection Period
...
```{r r3, fig.cap='The cyclical (R3a) and initial negative pattern (R3b) in recruitment deviations for the robustness tests that investigate the impact of climate change on the performance of the CMPs. R0 is the reference model where no additional recruitment variabililty is added.'}
...
A [Summary Report](../Reports/OM_Summary/2023/OM_Summary_Report.html) summarizes the diagnostic checks, the calculated biological reference points, and the estimated stock status relative to those reference points, across the Reference and Robustness operating models.
...
```{r addindex-plot, fig.cap='The additional individual fishery-dependent and survey indices for the North Atlantic swordfish fishery.', out.width = "400px"}
...
```{r C1, fig.cap='An example of time-series plots of the TAC for two CMPs. This OM has 10 simulations, shown as the colored lines. The points indicate the values used to calculate the median value.', out.width = "400px"}
...
```{r AvC10, fig.cap='An example of time-series plots of the TAC for a two CMPs. This OM has 10 simulations, shown as the colored lines. The points indicate the values used to calculate the median value.', out.width = "400px"}
...
```{r AvCmed, fig.cap='An example of time-series plots of the TAC for a two CMPs. This OM has 10 simulations, shown as the colored lines. The points indicate the values used to calculate the median value.', out.width = "400px"}
...
```{r AvC30, fig.cap='An example of time-series plots of the TAC for a two CMPs. This OM has 10 simulations, shown as the colored lines. The points indicate the values used to calculate the median value.', out.width = "400px"}
...
```{r VarC, fig.cap='Violin plots of the relative absolute change in the TAC between management cycles for two CMPs.', out.width = "400px"}
