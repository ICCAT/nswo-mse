...
The operating model in `openMSE`, including assumptions and equations, is described in detail in @carruthersDataLimitedMethodsToolkit2018a.
...
A draft SCRS report summarizing the parameters, estimated reference points, and predicted stock dynamics for the 216 OMs in the uncertainty grid is available on the North Atlantic Swordfish MSE [homepage](https://iccat.github.io/nswo-mse/).
