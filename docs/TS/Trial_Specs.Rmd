...
This set of 6 operating models has the same assumptions as the Reference OMs, except that there is a consistent 10% overage in the TAC in each year. 
...
This set of 6 operating models has the same assumptions as the Reference OMs with the exception that the management cycle is modified from the default assumption of 3 years (see [below](#interval) for details). 

Three alternative management intervals are considered in addition to the default 3-year interval:

1. 1-year management interval

2. 2-year management interval

3. 4-year management interval
