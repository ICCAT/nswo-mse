...
Figure \@ref(fig:PGKmed) shows an example for an operating model with 10 simulations. The value for `PGK_med` in this example is: `r PMlist$PGK_med`.
...
Figure \@ref(fig:PGKlong) shows an example for an operating model with 10 simulations. The value for `PGK_long` in this example is: `r PMlist$PGK_long`.
...
Figure \@ref(fig:PGK) shows an example for an operating model with 10 simulations. The value for `PGK` in this example is: `r PMlist[['PGK']]`.
...
Figure \@ref(fig:PGK30) shows an example for an operating model with 10 simulations. The value for `PGK_30` in this example is: `r PMlist$PGK_30`.
...
Figure \@ref(fig:LRPlong) shows an example for an operating model with 10 simulations. The value for `LRP_long` in this example is: `r PMlist$LRP_long`.
...
Figure \@ref(fig:LRP) shows an example for an operating model with 10 simulations. The value for `LRP` in this example is: `r PMlist$LRP`.
...
Figure \@ref(fig:C1) shows an example for an operating model with 10 simulations. The value for `C1` in this example is: `r round(PMlist$C1,0)`.

![(#fig:C1) An example of time-series plots of the TAC for a single MP. This OM has 10 simulations, shown as the colored lines. The points indicate the values used to calculate the median value.](../../img/PMs/C1.png){width=75%}
...
Figure \@ref(fig:AvC10) shows an example for an operating model with 10 simulations. The value for `AvC10` in this example is: `r round(PMlist$AvC10,0)`.

![(#fig:AvC10) An example of time-series plots of the TAC for a single MP. This OM has 10 simulations, shown as the colored lines. The points indicate the values used to calculate the median value.](../../img/PMs/AvC10.png){width=75%}
...
Figure \@ref(fig:AvC30) shows an example for an operating model with 10 simulations. The value for `AvC30` in this example is: `r round(PMlist$AvC30,0)`.

![(#fig:AvC30) An example of time-series plots of the TAC for a single MP. This OM has 10 simulations, shown as the colored lines. The points indicate the values used to calculate the median value.](../../img/PMs/AvC30.png){width=75%}
...
Figure \@ref(fig:VarC) shows an example for an operating model with 10 simulations. The value for `VarC` in this example is: `r PMlist$VarC`. The value for `MaxVarC` in this example is: `r PMlist$MaxVarC`.

![(#fig:VarC) An example of time-series plots of the relative change in the TAC between management cycles for a single MP. This OM has 10 simulations, shown as the colored lines. The median and maximum absolute change are shown in the top left corner.](../../img/PMs/VarC.png){width=75%}
