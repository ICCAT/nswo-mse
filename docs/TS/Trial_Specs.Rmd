...
The operating model in `openMSE`, including assumptions and equations, is described in detail in @carruthers2018.
...
The following sections show figures and statistics for examples from each family of Performance Metrics. These results include two example candidate management procedures (MP1, MP2) (see [Candidate Management Procedures](#CMPs)), with a single operating model that includes 10 stochastic simulations.
...
PM_desc2 <- PM_desc |> dplyr::filter(Name!='PNOF')
PM_df$Name <- PM_desc2$Name
...
Figure \@ref(fig:PGKshort) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The values for `PGK_short` in this example are: `r as.numeric(PM_df[1,1:2])`.
...
Figure \@ref(fig:PGKmed) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The values for `PGK_med` in this example are: `r as.numeric(PM_df[2,1:2])`.
...
Figure \@ref(fig:PGKlong) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The values for `PGK_long` in this example are: `r`as.numeric(PM_df[3,1:2])\`.
...
Figure \@ref(fig:PGK) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The values for `PGK` in this example are: `r as.numeric(PM_df[4,1:2])`.
...
Figure \@ref(fig:PGK30) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The values for `PGK_30` in this example are: `r as.numeric(PM_df[5,1:2])`.
...
Figure \@ref(fig:POF) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The values for `POF` in this example are: `r as.numeric(PM_df[6,1:2])`.

`PNOF` reports the probability of not overfishing, calculated as $1-\text{POF}$, i.e. `r 1-as.numeric(PM_df[6,1:2])`.
...
Figure \@ref(fig:LRPshort) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The values for `LRP_short` in this example are: `r as.numeric(PM_df[7,1:2])`.
...
Figure \@ref(fig:LRP-med) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The values for `LRP_med` in this example are: `r as.numeric(PM_df[8,1:2])`.
...
Figure \@ref(fig:LRP-long) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The value for `LRP_long` in this example are: `r as.numeric(PM_df[9,1:2])`.
...
Figure \@ref(fig:LRP) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The value for `LRP` in this example are: `r as.numeric(PM_df[10,1:2])`.
...
Figure \@ref(fig:C1) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The values for `TAC1` in this example are: `r as.numeric(PM_df[11,1:2])`.
...
Figure \@ref(fig:AvC10) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The values for `AvTAC_short` in this example are: `r as.numeric(PM_df[12,1:2])`.
...
Figure \@ref(fig:AvCmed) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The values for `AvTAC_med` in this example are: `r as.numeric(PM_df[13,1:2])`.
...
Figure \@ref(fig:AvC30) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The values for `AvTAC_long` in this example are: `r as.numeric(PM_df[14,1:2])`.
...
Figure \@ref(fig:VarC) shows an example of two CMPs (MP1, MP2) for an operating model with 10 simulations. The values for `VarC` in this example are: `r as.numeric(PM_df[15,1:2])`.
...
The NSWO R Shiny App is accessible on the [ICCAT MSE website](https://iccat.github.io/iccat-mse-web/species/NSWO_MSE.html)
