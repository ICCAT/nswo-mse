...
`C1` calculates the median TAC (t) in the first year (2024). This is calculated as the median across the simulations of the 2024 TAC (in most cases the TAC will be the same for all simulations in the first implementation year).  

Figure \@ref(fig:C1) shows an example of two CMPs (`r PMlist$MPs`) for an operating model with `r MSE_1@nsim` simulations. The values for `C1` in this example are: `r round(PMlist$C1,0)`.
...
`AvC10` calculates the median landed catch (t) in the first 10 years (2024--2033). This is calculated as the median catch across the simulations and years. 

Figure \@ref(fig:AvC10) shows an example of two CMPs (`r PMlist$MPs`) for an operating model with `r MSE_1@nsim` simulations. The values for `AvC10` in this example are: `r round(PMlist$AvC10,0)`.
...
`AvC30` calculates the median landed catch (t) in the last 20 years (2034--2053). This is calculated as the median catch across the simulations and years. 

Figure \@ref(fig:AvC30) shows an example of two CMPs (`r PMlist$MPs`) for an operating model with `r MSE_1@nsim` simulations. The values for `AvC30` in this example are: `r round(PMlist$AvC30,0)`.
