...
The `SWOMSE` package can be installed directly from the [GitHub repository](https://github.com/ICCAT/nswo-mse) using the `remotes` package:
...
The OMs in the uncertainty grid, conditioned using SS3, were imported into MSE framework using the `SS2MOM` function in `MSEtool` (see [here](https://msetool.openmse.com/reference/SS2MOM.html) for details on the function).
...
The operating models have been conditioned on data up to 2020. As described [above](#future-catches), the model assumes that the catch in 2021 -- 2023 is equal to the current TAC (13,200 ton), and then begins applying the CMPs in 2024.
