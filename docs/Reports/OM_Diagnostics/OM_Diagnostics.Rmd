...
`r tab.cap()` The uncertainty grid is a full factorial design with the following `r n_factors` factors, resulting in `r nrow(OM_DF)-1` OMs. The parameters used to condition this OM are indicated with bold text in blue boxes.
