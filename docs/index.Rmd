...
Diagnostic Reports for the Combined and Additional Indices for the Reference OMs:

```{r, results='asis'}
fls <- list.files('Index_Diagnostics',)
for (fl in fls) {
  nm <- strsplit(fl, ".html")[[1]]
  txt <- paste0('\n 1. ', '[', nm, ']', '(Index_Diagnostics/', fl, ')')
  cat(txt)
}
